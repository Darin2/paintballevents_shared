...
// Function to print Portuguese districts as dropdown options
function printPortugueseDistrictsAsDropdownOptions() {
    $portugueseDistricts = [
    ...
    foreach ($portugueseDistricts as $district) {
        ...
        if ($stmt->prepare($sql)) {
            ...
            if ($stmt->execute()) {
                $_SESSION['add_field_msg'] = "<div class='alert alert-success'>
                    ...
                    <a href='add_portugal_field.php' class='btn btn-primary'>Submit Another Field</a>
                </div>";
            } else {
...
<head>
    ...
    <title>Add Portuguese Paintball Field</title>
...
<body>
    ...
    <div class="container mt-4">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <h1 class="text-center mb-4">Add Portuguese Paintball Field</h1>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    <label for="paintballFieldState" class="form-label">District *</label>
                                    <select class="form-select" id="paintballFieldState" name="paintballFieldState" required>
                                        <?php echo printPortugueseDistrictsAsDropdownOptions(); ?>
                                    </select>
                                </div>

                                <div class="col-md-4 mb-3">
                                    <label for="paintballFieldZipcode" class="form-label">Postal Code *</label>
                                    <input type="text" class="form-control" id="paintballFieldZipcode" name="paintballFieldZipcode" pattern="^\d{4}-\d{3}$" placeholder="1234-567" required>
                                </div>
                            </div>
    ...
    <script>
        ...
        document.getElementById('paintballFieldZipcode').addEventListener('input', function(e) {
            ...
            // Add dash after 4 digits if we have more than 4 digits
            if (value.length > 4) {
