...
<head>
    ...
    <title>Add American Paintball Field</title>
...
<body>
    ...
    <div class="container mt-4">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <h1 class="text-center mb-4">Add American Paintball Field</h1>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select class="form-select" id="paintballFieldState" name="paintballFieldState" required>
                                        <?php echo printStatesAsDropdownOptions(); ?>
                                    </select>
                                </div>

                                <div class="col-md-4 mb-3">
                                    <label for="paintballFieldZipcode" class="form-label">Zipcode *</label>
