        ...
        if ($stmt->prepare($sql)) {
            ...
            if ($stmt->execute()) {
                $_SESSION['add_field_msg'] = "<div class='alert alert-success'>
                    <h4>Success!</h4>
                    <p>Thank you for submitting a Canadian paintball field. It will be reviewed and added to the database.</p>
                    <a href='add_canadian_field.php' class='btn btn-primary'>Submit Another Field</a>
                </div>";
            } else {
...
<head>
    ...
    <title>Add Canadian Paintball Field</title>
...
<body>
    ...
    <div class="container mt-4">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <h1 class="text-center mb-4">Add Canadian Paintball Field</h1>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="paintballFieldZipcode" name="paintballFieldZipcode" pattern="^[A-Za-z]\d[A-Za-z][ -]?\d[A-Za-z]\d$" required>
