        ...
        if ($stmt->prepare($sql)) {
            ...
            if ($stmt->execute()) {
                $_SESSION['add_field_msg'] = "<div class='alert alert-success'>
                    <h4>Success!</h4>
                    <p>Thank you for submitting a French paintball field. It will be reviewed and added to the database.</p>
                    <a href='add_france_field.php' class='btn btn-primary'>Submit Another Field</a>
                </div>";
            } else {
                $_SESSION['add_field_msg'] = "<div class='alert alert-danger'>
                    <h4>Error</h4>
                    <p>An error occurred while submitting the field: " . $stmt->error . "</p>
                </div>";
            }
        }
    } else {
...
<head>
    ...
    <title>Add French Paintball Field</title>
...
<body>
    ...
    <div class="container mt-4">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <h1 class="text-center mb-4">🇫🇷 Add French Paintball Field</h1>
                ...
                <form method="POST" class="needs-validation" novalidate>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    <label for="paintballFieldState" class="form-label">Region *</label>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <div class="form-text">Format: 75001</div>
                                </div>
                            </div>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <label for="googlemapShortLink" class="form-label">Google Maps Short Link</label>
