        ...
        if ($stmt->prepare($sql)) {
            ...
            if ($stmt->execute()) {
                $_SESSION['add_field_msg'] = "<div class='alert alert-success'>
                    <h4>Success!</h4>
                    <p>Thank you for submitting a Malaysian paintball field. It will be reviewed and added to the database.</p>
                    <a href='add_malaysia_field.php' class='btn btn-primary'>Submit Another Field</a>
                </div>";
            } else {
...
<head>
    ...
    <title>Add Malaysian Paintball Field</title>
...
<body>
    ...
    <div class="container mt-4">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <h1 class="text-center mb-4">Add Malaysian Paintball Field</h1>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    <label for="paintballFieldState" class="form-label">State *</label>
                                ...
                                <div class="col-md-4 mb-3">
                                    <label for="paintballFieldZipcode" class="form-label">Postcode *</label>
