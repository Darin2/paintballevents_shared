...
function printAllFieldsAsCards() {
    $conn = dbConnect();
    $result = "<div class='col-sm-12 col-md-6 col-lg-4 col-xl-4 mx-auto my-4'>";

    $sql = "SELECT fieldID, paintballFieldName, paintballFieldWebsite, paintballFieldWebsiteEventPage, 
            paintballFieldStreetAddress, paintballFieldCity, paintballFieldState, paintballFieldZipcode, 
            googlemapShortLink, paintballFieldFacebookPage, paintballFieldInstagramPage, paintballFieldTiktokPage 
            FROM `fields` ORDER BY paintballFieldName ASC";
    $stmt = $conn->stmt_init();

    if ($stmt->prepare($sql)) {
        $stmt->execute();
        $stmt->bind_result($fieldID, $name, $website, $eventPage, $address, $city, $state, $zipcode, 
                          $googleMap, $facebook, $instagram, $tiktok);
            ...
            <div class='col-12 mx-auto my-4'>
                <div class='card h-100 shadow-sm'>
                    <div class='card-header bg-light py-3'>
                        <h3 class='card-title h5 mb-0 fw-bold'>$name</h3>
                    </div>
                    <div class='card-body'>
                        <form class='needs-validation' novalidate>
                            <div class='row g-4'>
                                ...
                                <div class='col-12'>
                                    <div class='form-group'>
                                        <label class='form-label fw-semibold mb-2'>Street Address</label>
                                        <div class='input-group has-validation'>
                                            <input type='text' class='form-control editable-field' 
                                                   data-field-id='$fieldID' 
                                                   data-field-name='paintballFieldStreetAddress'
                                                   value='$address' 
                                ...
                                <div class='col-3'>
                                    <div class='form-group'>
                                        ...
                                        <div class='input-group has-validation'>
                                            <input type='text' class='form-control editable-field' 
                                                   data-field-id='$fieldID' 
                                                   data-field-name='paintballFieldCity'
                                                   value='$city' 
                                                   placeholder='City'>
                                            <button type='button' class='btn btn-primary save-button d-none' title='Save changes'>
                                                <i class='fa fa-save'></i> Save
                                ...
                                <div class='col-3'>
                                    <div class='form-group'>
                                        ...
                                        <div class='input-group has-validation'>
                                            <input type='text' class='form-control editable-field' 
                                                   data-field-id='$fieldID' 
                                                   data-field-name='paintballFieldState'
                                                   value='$state' 
                                                   placeholder='State'
                                                   maxlength='2'>
                                            <button type='button' class='btn btn-primary save-button d-none' title='Save changes'>
                                ...
                                <div class='col-3'>
                                    <div class='form-group'>
                                        <label class='form-label fw-semibold mb-2'>Zipcode</label>
                                        <div class='input-group has-validation'>
                                            <input type='text' class='form-control editable-field' 
                                                   data-field-id='$fieldID' 
                                                   data-field-name='paintballFieldZipcode'
                                                   value='$zipcode' 
                                                   placeholder='Zipcode'
                                                   pattern='[0-9]{5}'>
                                            <button type='button' class='btn btn-primary save-button d-none' title='Save changes'>
...
<body>
    ...
    <h1 class="text-white pt-4">Paintball Fields</h1>
...
<?php //this file prints all the paintball fields as cards and allows edits. ?>