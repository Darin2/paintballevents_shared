...
function printAllFieldsAsCards() {
    ...
    $sql = "SELECT fieldID, paintballFieldName, paintballFieldWebsite, paintballFieldWebsiteEventPage, 
        ...
        isPublished
        FROM `fields` 
        WHERE country_code = 'CAN' AND isPublished = 0
...
function countFields() {
    ...
    $sql = "SELECT COUNT(*) FROM `fields` WHERE country_code = 'CAN' AND isPublished = 0";
    $stmt = $conn->stmt_init();
...
<body>
    ...
    <h1 class="text-white mx-auto mt-5">🇨🇦 We found <?php echo countFields(); ?> unpublished fields in Canada</h1>
