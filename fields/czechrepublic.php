...
function printAllFieldsAsCards() {
    ...
    $sql = "SELECT fieldID, paintballFieldName, paintballFieldWebsite, paintballFieldWebsiteEventPage, 
        ...
        isPublished
        FROM `fields` 
        WHERE country_code = 'CZE' AND isPublished = 1
...
function countFields() {
    ...
    $sql = "SELECT COUNT(*) FROM `fields` WHERE country_code = 'CZE' AND isPublished = 1";
    $stmt = $conn->stmt_init();
...
<head>
    ...
    <title>🇨🇿 Czech Republic fields</title>
...
<body>
    ...
    <h1 class="text-white mx-auto mt-5">🇨🇿 We found <?php echo countFields(); ?> published fields in Czech Republic</h1>
