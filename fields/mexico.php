...
function printAllFieldsAsCards() {
    ...
    $sql = "SELECT fieldID, paintballFieldName, paintballFieldWebsite, paintballFieldWebsiteEventPage, 
        ...
        isPublished
        FROM `fields` 
        WHERE country_code = 'MEX' AND isPublished = 0
...
function countFields() {
    ...
    $sql = "SELECT COUNT(*) FROM `fields` WHERE country_code = 'MEX' AND isPublished = 0";
    $stmt = $conn->stmt_init();
...
<body>
    ...
    <h1 class="text-white mx-auto mt-5">🇲🇽 We found <?php echo countFields(); ?> unpublished fields in Mexico</h1>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        editableFields.forEach(field => {
            ...
            // Find the save button within the same input group
