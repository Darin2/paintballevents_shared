...
function printAllFieldsAsCards() {
    ...
    $sql = "SELECT fieldID, paintballFieldName, paintballFieldWebsite, paintballFieldWebsiteEventPage, 
        ...
        isPublished, latitude, longitude
        FROM `fields` 
        WHERE country_code = 'AUT' AND isPublished = 1
    ...
    if ($stmt->prepare($sql)) {
        ...
        $stmt->bind_result($fieldID, $name, $website, $eventPage, $fullAddress, 
                   $googleMap, $facebook, $instagram, $tiktok, $isPublished, $latitude, $longitude);
                                    ...
                                    <div class='form-group'>
                                        ...
                                        <div class='input-group'>
                                            <input type='text' class='form-control editable-field' 
                                                   ...
                                                   value='$latitude' 
                                                   placeholder='Latitude (e.g., 47.8095)'>
                                            <button type='button' class='btn btn-primary save-button d-none' title='Save changes'>
                                                <i class='fa fa-save'></i> Save
                                            </button>
                                        </div>
                                    ...
                                    <div class='form-group'>
                                        ...
                                        <div class='input-group'>
                                            <input type='text' class='form-control editable-field' 
                                                   ...
                                                   value='$longitude' 
                                                   placeholder='Longitude (e.g., 16.2000)'>
                                            <button type='button' class='btn btn-primary save-button d-none' title='Save changes'>
                                                <i class='fa fa-save'></i> Save
                                            </button>
                                        </div>
...
function countFields() {
    ...
    $sql = "SELECT COUNT(*) FROM `fields` WHERE country_code = 'AUT' AND isPublished = 1";
    $stmt = $conn->stmt_init();
...
<body>
    ...
    <h1 class="text-white mx-auto mt-5">🇦🇹 We found <?php echo countFields(); ?> published fields in Austria</h1>
