...
function printAllFieldsAsCards() {
    ...
    $sql = "SELECT fieldID, paintballFieldName, paintballFieldWebsite, paintballFieldWebsiteEventPage, 
        ...
        isPublished
        FROM `fields` 
        WHERE country_code = 'ESP' AND isPublished = 0
        ORDER BY isPublished DESC, paintballFieldName ASC";
        ...
        while ($stmt->fetch()) {
            ...
            <div class='field-card col-12 mx-auto my-4'>
                <div class='card h-100 shadow-sm'>
                    ...
                    <div class='mt-2'>$publishedBadge</div>
                </div>
...
function countFields() {
    ...
    $sql = "SELECT COUNT(*) FROM `fields` WHERE country_code = 'ESP' AND isPublished = 0";
    $stmt = $conn->stmt_init();
...
<body>
    ...
    <h1 class="text-white mx-auto mt-5">🇪🇸 We found <?php echo countFields(); ?> unpublished fields in Spain</h1>
