...
function printAllFieldsAsCards() {
    ...
    $sql = "SELECT fieldID, paintballFieldName, paintballFieldWebsite, paintballFieldWebsiteEventPage, 
        ...
        FROM `fields` 
        WHERE country_code = 'FIN' AND isPublished = 1
...
function countFields() {
    ...
    $sql = "SELECT COUNT(*) FROM `fields` WHERE country_code = 'FIN' AND isPublished = 1";
    $stmt = $conn->stmt_init();
...
<body>
    ...
    <h1 class="text-white mx-auto mt-5">🇫🇮 We found <?php echo countFields(); ?> published fields in Finland</h1>
