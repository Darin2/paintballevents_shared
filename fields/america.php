...
function printAllFieldsAsCards() {
    ...
    if ($stmt->prepare($sql)) {
        $stmt->execute();
        $stmt->bind_result($fieldID, $name, $website, $eventPage, $streetAddress, 
                   $city, $state, $zipcode, $googleMap, $facebook, $instagram, $tiktok, $isPublished);
                    ...
                    <div class='card-body'>
                        <form class='needs-validation' novalidate>
                            <div class='row g-4'>
                                ...
                                <div class='col-md-6'>
                                    <div class='form-group'>
                                        <label class='form-label fw-semibold mb-2'>Zip Code</label>
                                        <div class='input-group has-validation'>
                                            <input type='text' class='form-control editable-field' 
                                                data-field-id='$fieldID' 
...
function countFields() {
    ...
    $sql = "SELECT COUNT(*) FROM `fields` WHERE country_code = 'USA'";
    $stmt = $conn->stmt_init();
...
<body>
    ...
    <h1 class="text-white mx-auto mt-5">🇺🇸 We found <?php echo countFields(); ?> fields in America</h1>
